...
class PaymentMethod extends StatelessWidget {
 ...
 backgroundColor: whiteColor,
      ...
      bottomNavigationBar:  SizedBox(
        height: 60,
        child: btn(() async{
        await controller.placemyorder(orderpaymentmethod: paymentmethod[controller.paymentindex.value],total: controller.totalprice.value);
            ...
            child: Stack(
              ...
              children: [
                Image.asset(
                  ...
                  paymentmethodimgs[index],width: double.infinity,height: 120,fit: BoxFit.cover,),
               controller.paymentindex.value==index? Transform.scale(
                  scale: 1.3,
                  child: Checkbox(activeColor: Colors.green ,value: true, onChanged: (value){},shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(50)),))
                  : Container(),
                  Positioned(
                    bottom: 7,
                    right: 10,
                    child: paymentmethod[index].text.white.size(16).fontFamily(semibold).make())
              ],
            ),
          ),
        );
