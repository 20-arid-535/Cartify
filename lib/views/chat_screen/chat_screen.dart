...
import 'package:cartify_app/controller/chats_controller.dart';
import 'package:cartify_app/services/firestore_services.dart';
import 'package:cartify_app/views/chat_screen/components/sender_bubble.dart';
    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          Obx(
            ()=>
            controller.isloadind.value? Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(redColor),)):
               
             Expanded(child:StreamBuilder(stream: FirestoreServices.getchatsmsg(controller.chatdocid.toString()), builder: 
