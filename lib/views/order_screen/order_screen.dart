...
import 'package:cartify_app/views/order_screen/order_detail.dart';
      ...
      body: StreamBuilder(
       ...
       builder: (BuildContext context , AsyncSnapshot<QuerySnapshot> snapshot){
         if(!snapshot.hasData){
          ...
          return Center(child: "No order yet!".text.color(darkFontGrey).make(),);
        }
        else{
var data =snapshot.data!.docs;
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index){
             ...
             trailing: IconButton(onPressed: ( ){Get.to(()=>OrderDetail(data: data[index],));}, icon: Icon(Icons.arrow_forward_ios_rounded),color: darkFontGrey,),
              );
            });
        }
       }),
